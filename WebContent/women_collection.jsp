...
$(document).ready(function() {
	...
	if (this.readyState == 4 && this.status == 200) {
			...
			for (var i = 0; i < arr.length; i++) {
				...
				ans += "<td style=\"padding:10px 10px 10px 10px;text-align:center;\"><img src= \" "+ arr[i].product_photo +" \" style=\" border-radius: 0.5em; width:auto;\" ><br><br><label class=\"text-dark\" ><b>Price : $"+arr[i].price+"</b></label><br><br><input type = \"button\" value=\"Add to cart\" class=\"btn btn-outline-dark btn-block\" onClick=\"add_product(\'"+arr[i].product_id+"\')\" /> &nbsp</td>";
			  }
			ans += "</tr>";
			ans += "</table>";
	...
	<div class="container" style="text-align: center">
		...
		<div class="container"
			...
			<div class="nav flex-column nav-pills" aria-orientation="vertical">
				...
				<div class="dropdown-divider"></div>
				<a class="nav-link active" href="women_collection.jsp?product_name=default&category=women"><b>Women
